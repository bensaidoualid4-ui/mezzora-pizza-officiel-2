...
const Footer = () => {
  return (
    <footer className="bg-[var(--bg-card)] border-t border-[var(--cream)]/10 py-12" data-testid="footer">
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex flex-col md:flex-row items-center gap-6 text-[var(--cream-muted)] text-xs tracking-wider">
            ...
            <a href="tel:0147494904" className="flex items-center gap-2 hover:text-[var(--red)] transition-colors"><Phone className="w-3 h-3" /> 01 47 49 49 04</a>
          </div>

          <p className="text-[var(--cream-muted)]/50 text-xs">&copy; 2025 Mezzora Pizza</p>
        </div>
      </div>
    </footer>
  );
