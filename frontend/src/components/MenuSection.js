  ...
  const PizzaCard = ({ pizza }) => (
    <div className="group" data-testid={`pizza-card-${pizza.id}`}>
      ...
      <div className="flex gap-4 text-xs">
        <span className="text-[var(--cream-muted)]">Junior <span className="text-[var(--gold)]">{pizza.junior.toFixed(2)}€</span></span>
        <span className="text-[var(--cream-muted)]">Senior <span className="text-[var(--gold)]">{pizza.senior.toFixed(2)}€</span></span>
        <span className="text-[var(--cream-muted)]">Méga <span className="text-[var(--gold)]">{pizza.mega.toFixed(2)}€</span></span>
      </div>
    </div>
  );
  ...
  const SimpleCard = ({ item }) => (
    <div className="group" data-testid={`item-card-${item.id}`}>
      ...
      <div className="flex justify-between items-start">
        ...
        <span className="text-[var(--gold)] font-serif text-lg flex-shrink-0">{item.price.toFixed(2)}€</span>
      </div>
    </div>
  );
