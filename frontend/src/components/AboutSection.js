...
const AboutSection = () => {
  return (
    <section className="py-16 md:py-20 bg-warm" id="about" data-testid="about-section">
      <div className="container mx-auto px-4 max-w-5xl">
        <div className="text-center mb-10">
          <p className="text-mz-red font-semibold text-sm uppercase tracking-widest mb-2">Depuis 1997</p>
        ...
        <p className="text-center text-mz-muted text-base md:text-lg max-w-2xl mx-auto mb-12 leading-relaxed">
          Depuis plus de <strong className="text-mz-brown">28 ans</strong>, Mezzora Pizza régale les habitants de Rueil-Malmaison 
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="warm-card rounded-2xl p-6 text-center" data-testid="about-card-pate">
            <div className="w-14 h-14 bg-red-50 rounded-2xl flex items-center justify-center mx-auto mb-4">
              <Flame className="w-7 h-7 text-mz-red" />
            </div>
            <h3 className="font-bold text-lg text-mz-brown mb-2">Pâte Fraîche Maison</h3>
            <p className="text-mz-muted text-sm leading-relaxed">
              100% préparée sur place chaque jour. Jamais surgelée, jamais industrielle.
            </p>
          </div>

          <div className="warm-card rounded-2xl p-6 text-center" data-testid="about-card-ingredients">
            <div className="w-14 h-14 bg-green-50 rounded-2xl flex items-center justify-center mx-auto mb-4">
              <Award className="w-7 h-7 text-mz-green" />
            </div>
            <h3 className="font-bold text-lg text-mz-brown mb-2">Ingrédients Frais</h3>
            <p className="text-mz-muted text-sm leading-relaxed">
              Légumes frais du marché, viandes de qualité, fromages sélectionnés avec soin.
            </p>
          </div>

          <div className="warm-card rounded-2xl p-6 text-center" data-testid="about-card-experience">
            <div className="w-14 h-14 bg-amber-50 rounded-2xl flex items-center justify-center mx-auto mb-4">
              <Clock className="w-7 h-7 text-mz-gold" />
            </div>
            <h3 className="font-bold text-lg text-mz-brown mb-2">28 Ans d'Expérience</h3>
            <p className="text-mz-muted text-sm leading-relaxed">
