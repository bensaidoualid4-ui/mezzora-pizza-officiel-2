  ...
  <div className="py-10" data-testid="offres-section">
    <div className="container mx-auto px-6 max-w-3xl">
      <div className="text-center mb-12">
        <p className="text-[var(--gold)] text-xs tracking-[0.3em] uppercase mb-4">Offres Spéciales</p>
      ...
      <div className="text-center mb-16">
        ...
        <p className="font-serif text-4xl md:text-5xl text-[var(--gold)] italic">= La 3ème Offerte</p>
      ...
      <div className="text-center mt-12">
        <p className="text-[var(--cream-muted)] text-sm">Livraison <span className="text-[var(--gold)]">gratuite</span> dès 12€ le soir</p>
      </div>
    </div>
  </div>
);
